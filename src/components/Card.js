				...
				<div className='card__house card__house--back'>
					<div className='house__details'>
						...
						<ul className='house__list'>
							<li className='house__item house__item--emojiBed'>{`${bedrooms} bedrooms`}</li>
							<li className='house__item house__item--emojiCity'>{`${city_distance}mi from city center`}</li>
							<li className='house__item house__item--emojiSchool'>{`${school_distance}mi from local school`}</li>
							<li className='house__item house__item--emojiParking'>{`parking, ${parking}`}</li>
						</ul>
